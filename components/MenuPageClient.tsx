                ...
                <div key={cat} className="menu-category-section">
                  {activeCategory === "all" && catInfo && (
                    <div className="menu-category-header">
                      <span className="menu-category-emoji">{catInfo.emoji}</span>
                      <div>
                        <div className="menu-category-title">{catInfo.label}</div>
                        {"tagline" in catInfo && (
                          <div className="menu-category-tagline">{catInfo.tagline}</div>
                        )}
                      </div>
                    </div>
                  )}
